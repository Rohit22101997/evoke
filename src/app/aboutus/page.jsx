...
function page() {
  ...
  <img src="/Images/p11.avif" alt="" className="absolute inset-0 -z-10 size-full object-cover object-right md:object-center" />
  ...
  <div className="mx-auto max-w-7xl px-6 lg:px-8">
    <div className="mx-auto max-w-2xl lg:mx-0">
      ...
      <p className="mt-8 text-lg font-medium text-pretty text-gray-300 sm:text-xl/8"> EVOKE DIGITAL, Collaboration isn’t a buzzword it’s our favorite strategy.
    ...
    <div className="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
      ...
      <dl className="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
        <div className="flex flex-col-reverse gap-1">
          <dt className="text-base/7 text-gray-300">Offices</dt>
