      ...
      <section className="px-4 sm:px-8 lg:px-16 pb-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          ...
          <div className="bg-gray-900 rounded-2xl overflow-hidden aspect-square hover:scale-105 transition-transform duration-300">
            <img
              src="/Images/modern-product-design-black-jacket-hanging.jpg"
          ...
          <div className="bg-gray-900 rounded-2xl overflow-hidden aspect-square hover:scale-105 transition-transform duration-300">
            <img
              src="/Images/person-wearing-headphones-profile-view-black-and-w.jpg"
          ...
          <div className="bg-gray-900 rounded-2xl overflow-hidden aspect-square hover:scale-105 transition-transform duration-300">
            <img
              src="/Images/minimalist-product-bottle-cosmetic-design.jpg"
