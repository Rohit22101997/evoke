  ...
  return (
    <div className="relative min-h-screen bg-neutral-50 flex items-center justify-center py-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div
        ...
        className="absolute right-12 top-1/2 -translate-y-1/2 transform -rotate-12 text-orange-500 opacity-100 pointer-events-none z-0" 
        style={{ fontSize: '20rem', fontFamily: 'myfont, sans-serif', lineHeight: '1' }}
      >
        blah
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        ...
        <div className="text-left py-8 lg:py-6">
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-extrabold leading-tight text-gray-900 mb-4">
            ...
            that make you <br />
            <span className="font-serif italic font-normal">impossible to ignore</span>
          </h1>
        </div>

        {/* Right Section - Descriptive Text */}
        {/* ⬆️ Change: Added -mt-6 for a minor shift upward */}
        <div className="flex justify-end lg:justify-start py-8 lg:py-16 -mt-6"> 
          <p className="max-w-md text-right lg:text-left text-lg text-gray-700 leading-relaxed pr-4 border-r-4 border-lime-300">
            CUSTOM SITES THAT ELEVATE YOUR BRAND, BOOST YOUR VISIBILITY, AND CLOSE THE RIGHT CLIENTS.
          </p>
        </div>
      </div>
    </div>
